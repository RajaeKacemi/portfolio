        ...
        <div className="w-full h-[60%] px-[20px] lg:px-0 lg:h-full lg:w-1/2 text-dark-800 dark:text-light-900 ">
            ...
            <div className="w-full h-[50%]  flex  flex-col  items-center lg:gap-0 lg:items-start gap-[30%] lg:justify-evenly">
                ...
                <div className=" flex items-center gap-[26px] ">
                    ...
                    <img src={(theme !== "dark") ? icons.twIcon : icons.twIconW} alt="Twitter" className=" w-[27px] h-[27px] lg:w-[40px] lg:h-[40px] hover:scale-110 transition duration-700 ease-in-out cursor-pointer" onClick={() => handleLinkedInClick(urlSocialMedia[2].url)} />
                </div>
            </div>
        </div>
    )
